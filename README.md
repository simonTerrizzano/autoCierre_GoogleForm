...
<h5>Para configurar un formulario de esta manera se deberá seguir los siguentes pasos:</h5>
  ...
  <ul><h7>Paso 5: Configurá Activadores/Triggers: Ir al apartado Activadores en AppScript, este se encuentra la columna izquierda y es la cuarta opción, en esta sección configurar 2 activadores, hay que seleccionar "Añadir activador", para el primer activador en la opción "Seleccionar qué función ejecutar" elegir "initialize", en la opción "Seleccionar qué despliegue se debe ejecutar" dejar como "Principal", en "Selecciona la fuente del evento" definir "De un formulario" y en "Selecciona el tipo de evento" seleccionar "Al enviarse el formulario".</h7></ul>
